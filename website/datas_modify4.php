...
<TD width = "150px "style="color:#C0C0C0"><a href="datas_modify4.php" style="color:#FFFFFF">RECORDING</TD>
...
<?php
    ...
    if ($run == 'insert') {
        ...
        $sql = "insert into recording (id, name, length) values ($id, '$name', '$length')";
        echo $sql;
        //echo $sql;
...
LENGTH:
<input type="text" name="length" class="kw" size="10" maxlength="100" style="color:#000"/> <br> <br>
Type of Operation:
