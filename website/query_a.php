...
<TABLE>
<TR>
<TD width = "40px "><a href="query_a.php"><h6 style="color:#FFA500">A</h6>
</TD>
...
<?php
    ...
    $stmt = oci_parse($conn, "Select count(*) as COUNTNUM from (select artist.NAME from ARTIST artist where artist.area_name='Switzerland')");
    ...
    $sql = "SELECT * from (select ar.*, rownum rm FROM ( select artist.NAME from ARTIST artist where artist.area_name='Switzerland') ar ) where rm between $offset and $num";
