...
<TD width = "150px "style="color:#C0C0C0"><a href="datas_modify1.php" style="color:#FFFFFF">ARTIST_GENRE</TD>
...
<?php
    ...
    if ($run == 'insert') {
        ...
        $sql = "insert into artist_genre (aid, gid) values ($aid, $gid)";
        echo $sql;
        //echo $sql;
    ...
    if ($run == 'delete') {
        $sql = "delete from artist_genre where ";
        $query = '';
        $flag = 0;
        if ($aid <> '') {
            if ($flag == 1) {
...
<br>
AID:
<input type="text" name="aid" class="kw" size="10" maxlength="100" style="color:#000"/> <br> <br>
GID:
