...
<TD width = "150px "style="color:#C0C0C0"><a href="datas_modify2.php" style="color:#FFFFFF">ARTIST_TRACK</TD>
...
<?php
    ...
    if ($run == 'insert') {
        ...
        $sql = "insert into artist_track (aid, tid) values ($aid, $gid)";
        echo $sql;
        //echo $sql;
    ...
    if ($run == 'delete') {
        $sql = "delete from artist_track where ";
        $query = '';
        $flag = 0;
        if ($aid <> '') {
            if ($flag == 1) {
